...
function AppContent() {
  ...
  if (!user) {
    ...
    // Auth view - Force light theme
    return (
      <div className="auth-light-mode min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
        <style>{`
          .auth-light-mode,
          .auth-light-mode * {
          ...
          .auth-light-mode .dark\\:bg-gray-900 {
            background-color: white !important;
          }
          .auth-light-mode .dark\\:text-white,
          .auth-light-mode .dark\\:text-gray-300,
          .auth-light-mode .dark\\:text-gray-400 {
            color: #1f2937 !important;
          }
          .auth-light-mode .dark\\:border-gray-600,
          .auth-light-mode .dark\\:border-gray-700,
          .auth-light-mode .dark\\:border-gray-800 {
            border-color: #d1d5db !important;
          }
          .auth-light-mode input {
            color: #1f2937 !important;
            background-color: white !important;
          }
          .auth-light-mode input::placeholder {
