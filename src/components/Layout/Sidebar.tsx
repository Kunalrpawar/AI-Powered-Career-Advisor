...
const Sidebar: React.FC<SidebarProps> = ({ activeSection, setActiveSection, onHomeClick }) => {
  return (
    <div className="w-64 bg-white/90 dark:bg-gray-900/90 backdrop-blur supports-[backdrop-filter]:bg-white/70 supports-[backdrop-filter]:dark:bg-gray-900/70 shadow-lg h-screen fixed left-0 top-0 z-10 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-800 flex-shrink-0">
        <button 
          onClick={onHomeClick}
          className="flex items-center space-x-3 w-full hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg p-2 transition-colors duration-200 group"
        >
          ...
          <div>
            <h1 className="text-xl font-extrabold text-gray-900 dark:text-gray-100 tracking-tight group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">AI Career</h1>
