...
const CareerExplorer: React.FC = () => {
  ...
  const predefinedInterests = [
    t('career_explorer.interests.web_development'),
    t('career_explorer.interests.ai_ml'),
    t('career_explorer.interests.cybersecurity'),
    t('career_explorer.interests.mobile_development'),
    t('career_explorer.interests.data_science'),
    t('career_explorer.interests.cloud_computing'),
    t('career_explorer.interests.devops'),
    t('career_explorer.interests.ui_ux_design')
  ];
    ...
    <div className="p-6 space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">{t('career_explorer.title')}</h2>
            <p className="text-gray-500 dark:text-gray-400">{t('career_explorer.subtitle')}</p>
          </div>
        </div>
        ...
        <div className="flex space-x-4 mb-6">
          ...
          >
            ...
            <span>{t('career_explorer.manual_input')}</span>
          </button>
          <button
          ...
          >
            ...
            <span>{t('career_explorer.upload_resume')}</span>
          </button>
        </div>
        ...
        {inputMode === 'resume' && (
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">{t('career_explorer.upload_resume_title')}</label>
            <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center hover:border-green-400 dark:hover:border-green-500 transition-colors">
              ...
              <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">{t('career_explorer.upload_resume')}</h3>
              <p className="text-gray-500 dark:text-gray-400 mb-4">{t('career_explorer.upload_resume_desc')}</p>
              <input
                type="file"
                accept=".pdf,.doc,.docx"
                className="hidden"
