    ...
    <div className="p-6 space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">{t('job_matcher.title')}</h2>
            <p className="text-gray-500 dark:text-gray-400">{t('job_matcher.subtitle')}</p>
          </div>
        </div>
        ...
        <div className="flex space-x-4 mb-6">
          ...
          >
            ...
            <span>{t('job_matcher.profile_summary')}</span>
          </button>
          <button
