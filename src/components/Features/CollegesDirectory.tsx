...
type College = {
  ...
  city: string;
  state: string;
  level: '11th' | 'undergraduate' | 'postgraduate'; // Added education level
  lat?: number;
  lng?: number;
  degrees: string[];
  facilities: string[];
...
const mockColleges: College[] = [
  // 11th Grade / Junior Colleges in Pune
  {
    id: 'jc1',
    name: 'Fergusson Junior College',
    city: 'Pune',
    state: 'Maharashtra',
    level: '11th',
    lat: 18.5204,
    lng: 73.8567,
    degrees: ['FYJC Science', 'FYJC Commerce', 'FYJC Arts'],
    facilities: ['Library', 'Laboratory', 'Sports', 'Computer Lab'],
    hostel: false,
    avgFeesPerYearINR: 15000,
    safetyScore: 4.5,
    phone: '+91-20-2567-8901',
    email: 'admissions@fergussonjr.edu.in',
    website: 'www.fergussonjr.edu.in',
    established: 1885,
    affiliation: 'Maharashtra State Board',
    ranking: 5,
    description: 'Premier junior college under Fergusson College with excellent academic record.'
  },
  {
    id: 'jc2',
    name: "St. Mira's Junior College",
    city: 'Pune',
    state: 'Maharashtra',
    level: '11th',
    lat: 18.5314,
    lng: 73.8446,
    degrees: ['FYJC Science', 'FYJC Commerce'],
    facilities: ['Library', 'Laboratory', 'Computer Lab', 'Auditorium'],
    hostel: true,
    avgFeesPerYearINR: 18000,
    safetyScore: 4.6,
    phone: '+91-20-2567-8902',
    email: 'info@stmirasjr.edu.in',
    website: 'www.stmirasjr.edu.in',
    established: 1962,
    affiliation: 'Maharashtra State Board',
    ranking: 8,
    description: 'Well-established junior college with focus on science and commerce education.'
  },
  {
    id: 'jc3',
    name: 'MIT Junior College of Science & Commerce',
    city: 'Pune',
    state: 'Maharashtra',
    level: '11th',
    lat: 18.5089,
    lng: 73.8077,
    degrees: ['FYJC Science', 'FYJC Commerce'],
    facilities: ['Modern Labs', 'Library', 'Computer Center', 'Sports Complex'],
    hostel: true,
    avgFeesPerYearINR: 25000,
    safetyScore: 4.7,
    phone: '+91-20-2567-8903',
    email: 'admissions@mitjr.edu.in',
    website: 'www.mitjr.edu.in',
    established: 1983,
    affiliation: 'Maharashtra State Board',
    ranking: 3,
    description: 'Part of MIT Group with state-of-the-art facilities and excellent placement support.'
  },
  {
    id: 'jc4',
    name: 'Sinhgad Junior College',
    city: 'Pune',
    state: 'Maharashtra',
    level: '11th',
    lat: 18.4580,
    lng: 73.8131,
    degrees: ['FYJC Science', 'FYJC Commerce', 'FYJC Arts'],
    facilities: ['Laboratory', 'Library', 'Sports', 'Computer Lab', 'Canteen'],
    hostel: true,
    avgFeesPerYearINR: 20000,
    safetyScore: 4.4,
    phone: '+91-20-2567-8904',
    email: 'info@sinhgadjr.edu.in',
    website: 'www.sinhgadjr.edu.in',
    established: 1996,
    affiliation: 'Maharashtra State Board',
    ranking: 12,
    description: 'Junior wing of Sinhgad institutions with comprehensive academic programs.'
  },
  {
    id: 'jc5',
    name: 'BMCC Junior College',
    city: 'Pune',
    state: 'Maharashtra',
    level: '11th',
    lat: 18.5314,
    lng: 73.8446,
    degrees: ['FYJC Commerce', 'FYJC Arts'],
    facilities: ['Library', 'Computer Lab', 'Auditorium', 'Career Guidance'],
    hostel: false,
    avgFeesPerYearINR: 16000,
    safetyScore: 4.3,
    phone: '+91-20-2567-8905',
    email: 'admissions@bmccjr.edu.in',
    website: 'www.bmccjr.edu.in',
    established: 1965,
    affiliation: 'Maharashtra State Board',
    ranking: 15,
    description: 'Specialized in commerce education with strong industry connections.'
  },
  
  // Undergraduate Colleges in Pune
  {
    id: 'ug1',
    ...
    lat: 18.5314,
    lng: 73.8446,
    degrees: ['B.Tech Computer Science', 'B.Tech Mechanical', 'B.Tech Civil', 'B.Tech Electronics'],
    facilities: ['Hostel', 'Laboratory', 'Library', 'WiFi', 'Placement Cell', 'Innovation Hub'],
    hostel: true,
    avgFeesPerYearINR: 45000,
    safetyScore: 4.8,
    phone: '+91-20-2567-8906',
    email: 'admissions@coep.ac.in',
    website: 'www.coep.ac.in',
    established: 1854,
    affiliation: 'COEP Technological University',
    ranking: 1,
    description: 'Premier engineering institution with autonomous university status and excellent research facilities.'
  },
  {
    id: 'ug2',
    ...
    lat: 18.5204,
    lng: 73.8567,
    degrees: ['B.Sc. Physics', 'B.Sc. Chemistry', 'B.A. English', 'B.Com. Accounting'],
    facilities: ['Library', 'Laboratory', 'Sports Complex', 'Computer Lab', 'Auditorium'],
    hostel: true,
    avgFeesPerYearINR: 25000,
    safetyScore: 4.6,
    phone: '+91-20-2567-8907',
    email: 'admissions@fergusson.edu',
    website: 'www.fergusson.edu',
    established: 1885,
    affiliation: 'Savitribai Phule Pune University',
    ranking: 4,
    description: 'Historic institution offering diverse undergraduate programs with emphasis on academic excellence.'
  },
  {
    id: 'ug3',
    ...
    lat: 18.4580,
    lng: 73.8131,
    degrees: ['B.Tech Computer Science', 'B.Tech Information Technology', 'B.Tech Electronics'],
    facilities: ['Modern Labs', 'Library', 'WiFi', 'Placement Cell', 'Innovation Center'],
    hostel: false,
    avgFeesPerYearINR: 85000,
    safetyScore: 4.7,
    phone: '+91-20-2567-8908',
    email: 'admissions@pict.edu',
    website: 'www.pict.edu',
    established: 1999,
    affiliation: 'Savitribai Phule Pune University',
    ranking: 6,
    description: 'Leading computer technology institute with strong industry partnerships and placement record.'
  },
  {
    id: 'ug4',
    ...
    lat: 18.5089,
    lng: 73.8077,
    degrees: ['B.Tech', 'BBA', 'B.Sc. Data Science', 'B.Des.'],
    facilities: ['Hostel', 'Library', 'Sports Complex', 'WiFi', 'International Programs'],
    hostel: true,
    avgFeesPerYearINR: 150000,
    safetyScore: 4.9,
    phone: '+91-20-2567-8909',
    email: 'admissions@siu.edu.in',
    website: 'www.siu.edu.in',
    established: 1971,
    affiliation: 'Symbiosis International (Deemed University)',
    ranking: 2,
    description: 'Premier deemed university with international standards and diverse academic programs.'
  },
  {
    id: 'ug5',
    ...
    lat: 18.4580,
    lng: 73.8131,
    degrees: ['B.Tech Computer Science', 'B.Tech Mechanical', 'B.Tech Civil', 'B.Tech IT'],
    facilities: ['Hostel', 'Laboratory', 'Library', 'Sports', 'Placement Cell'],
    hostel: true,
    avgFeesPerYearINR: 95000,
    safetyScore: 4.5,
    phone: '+91-20-2567-8910',
    email: 'admissions@vit.edu',
    website: 'www.vit.edu',
    established: 1983,
    affiliation: 'Savitribai Phule Pune University',
    ranking: 9,
    description: 'Well-established engineering college with focus on technical excellence and innovation.'
  },
  
  // Postgraduate Colleges in Pune
  {
    id: 'pg1',
    name: 'Savitribai Phule Pune University - PG Departments',
    city: 'Pune',
    state: 'Maharashtra',
    level: 'postgraduate',
    lat: 18.5089,
    lng: 73.8077,
    degrees: ['M.Sc. Physics', 'M.A. English', 'M.Com.', 'MBA', 'M.Tech'],
    facilities: ['Research Labs', 'Library', 'Hostel', 'Computer Center', 'Auditorium'],
    hostel: true,
    avgFeesPerYearINR: 35000,
    safetyScore: 4.6,
    phone: '+91-20-2567-8911',
    email: 'admissions@unipune.ac.in',
    website: 'www.unipune.ac.in',
    established: 1949,
    affiliation: 'State University',
    ranking: 7,
    description: 'Main university offering diverse postgraduate programs with research opportunities.'
  },
  {
    id: 'pg2',
    ...
    lat: 18.5314,
    lng: 73.8446,
    degrees: ['MBA General', 'MBA Finance', 'MBA Marketing', 'MBA HR'],
    facilities: ['Modern Classrooms', 'Library', 'Computer Lab', 'Placement Cell', 'International Exchange'],
    hostel: true,
    avgFeesPerYearINR: 225000,
    safetyScore: 4.8,
    ...
    affiliation: 'Symbiosis International (Deemed University)',
    ranking: 3,
    description: 'Top-ranked MBA college with excellent placement record and industry connections.'
  },
  {
    id: 'pg3',
    name: 'PUMBA - Pune University MBA',
    city: 'Pune',
    state: 'Maharashtra',
    level: 'postgraduate',
    lat: 18.5089,
    lng: 73.8077,
    degrees: ['MBA', 'Executive MBA', 'Part-time MBA'],
    facilities: ['Auditorium', 'Library', 'Computer Lab', 'Placement Cell', 'Case Study Rooms'],
    hostel: false,
    avgFeesPerYearINR: 65000,
    safetyScore: 4.4,
    phone: '+91-20-2567-8913',
    email: 'admissions@pumba.ac.in',
    website: 'www.pumba.ac.in',
    established: 1971,
    affiliation: 'Savitribai Phule Pune University',
    ranking: 12,
    description: 'University department offering MBA programs with focus on management education.'
  },
  {
    id: 'pg4',
    name: 'Deccan College Post Graduate & Research Institute',
    city: 'Pune',
    state: 'Maharashtra',
    level: 'postgraduate',
    lat: 18.5314,
    lng: 73.8446,
    degrees: ['M.A. Archaeology', 'M.A. Linguistics', 'M.A. History', 'PhD Programs'],
    facilities: ['Research Labs', 'Museum', 'Library', 'Archives', 'Field Work'],
    hostel: true,
    avgFeesPerYearINR: 28000,
    safetyScore: 4.3,
    phone: '+91-20-2567-8914',
    email: 'admissions@deccancollegepune.ac.in',
    website: 'www.deccancollegepune.ac.in',
    established: 1821,
    affiliation: 'Deemed University',
    ranking: 15,
    description: 'Specialized research institute focusing on archaeology, linguistics and ancient history.'
  },
  {
    id: 'pg5',
    ...
    lat: 18.5089,
    lng: 73.8077,
    degrees: ['MBA', 'PGDM', 'Executive MBA', 'PhD Management'],
    facilities: ['Smart Classrooms', 'Library', 'Computer Lab', 'Placement Cell', 'International Programs'],
    hostel: true,
    avgFeesPerYearINR: 180000,
    safetyScore: 4.7,
    phone: '+91-20-2567-8915',
    email: 'admissions@mitsom.edu.in',
    website: 'www.mitsom.edu.in',
    established: 1993,
    affiliation: 'MIT World Peace University',
    ranking: 8,
    description: 'Leading management school with strong industry interface and global exposure.'
  }
];
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className={`text-xs font-medium px-2 py-1 rounded-full ${
              college.level === '11th' ? 'bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-400' :
              college.level === 'undergraduate' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400' :
              'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-400'
            }`}>
              {college.level === '11th' ? '11th Grade' : college.level === 'undergraduate' ? 'UG' : 'PG'}
            </span>
          </div>
...
const CollegesDirectory: React.FC = () => {
  ...
  const [filters, setFilters] = useState({
    ...
    maxFees: 50000,
    minSafety: 3.0,
    educationLevel: 'all' as 'all' | '11th' | 'undergraduate' | 'postgraduate'
  });
  ...
  const getCurrentLocation = async () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        setIsLoadingLocation(false);
        // Only fetch if explicitly requested, don't auto-fetch
  ...
  const fetchNearbyColleges = async (lat: number, lng: number) => {
    ...
    // Fallback to mock data when API is not available or fails
    console.log('Using mock data with', mockColleges.length, 'colleges');
  ...
  const refreshSearch = () => {
    if (userLocation) {
      ...
      // If no user location, just ensure we have mock data
      setColleges(mockColleges);
    }
  };

  // Auto-refresh when radius changes (disabled for mock data)
  // useEffect(() => {
  //   if (userLocation) {
  ...
  const filteredColleges = useMemo(() => {
    let filtered = colleges.filter(college => {
      ...
      const matchesLevel = filters.educationLevel === 'all' || college.level === filters.educationLevel;
      
      return matchesQuery && matchesHostel && matchesFees && matchesSafety && matchesLevel;
    });
  ...
  useEffect(() => {
    // Initialize with mock data and auto-request location
    setColleges(mockColleges);
    getCurrentLocation();
  }, []);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2">
                Find colleges by education level: 11th Grade, Undergraduate, and Postgraduate programs in Pune
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
          ...
          {/* Advanced Filters */}
          <div className="grid md:grid-cols-4 gap-6 mt-6 pt-6 border-t border-gray-200 dark:border-gray-600">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Education Level</label>
              <select
                value={filters.educationLevel}
                onChange={(e) => setFilters({...filters, educationLevel: e.target.value as any})}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
              >
                <option value="all">All Levels</option>
                <option value="11th">11th Grade (Junior College)</option>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-600 flex items-center justify-between">
            <div className="flex items-center space-x-4 text-sm text-gray-600 dark:text-gray-400">
              ...
              <span>•</span>
              <span>Filter: {filters.educationLevel}</span>
            </div>
            {locationError && (
